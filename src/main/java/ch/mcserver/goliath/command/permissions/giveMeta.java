package ch.mcserver.goliath.command.permissions;
...
public class giveMeta implements SimpleCommand {

    private ProxyServer proxy;

    public giveMeta(ProxyServer proxy) {
        this.proxy = proxy;
    }
    ...
    public boolean hasPermission(Invocation invocation) {
        return invocation.source().hasPermission("GoliathCommand.giveMeta");
    }
}
